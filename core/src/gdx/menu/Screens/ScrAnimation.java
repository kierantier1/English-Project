...
public class ScrAnimation implements Screen, InputProcessor {
    ...
    SpriteBatch batch;
    public ScrAnimation(GamMenu _gamMenu) {  //Referencing the main class.
        gamMenu = _gamMenu;
    }
    ...
    public void show() {
        ...
        sKing1 = "How did they know? I'll surely be found out!";
        sKing2 = "I'll take the time to repent in prayer.";
        sSign = "Don't kill him now, he'll go to heaven!";
    ...
    public void render(float Delta) {
        ...
        if(isHitS(sprHD, sprDoor) && nTrig == 0){
            ...
            nTrig = 2;
        }else if(isHitS(sprHD, dudSign)){
            nTrig = 3;
        }else if(! isHitS(sprHD, sprDoor) && ! isHitS(sprHD, dudKing) && ! isHitS(sprHD, dudSign)){
            nTrig = 0;
        }
        ...
        if(nTrig == 1){
            ...
            tbDoor.draw(batch);
            bmf.setColor(Color.BLACK);
            bmf.draw(batch, sKing1, Gdx.graphics.getWidth() / 2 - 130, 20);
            bmf.draw(batch, sKing2, Gdx.graphics.getWidth() / 2 - 100, 40);
        }else if(nTrig == 3){
            tbDoor.draw(batch);
            bmf.setColor(Color.BLACK);
            bmf.draw(batch, sSign, Gdx.graphics.getWidth() / 2 - 110, 20);
        }
